...
static dare_log_entry_t* log_append_entry(dare_log_t* log, size_t data_size, void* data, view_stamp* vs, uint32_t node_id, view_stamp *highest_committed_vs)
{   
    /* Create new entry */
